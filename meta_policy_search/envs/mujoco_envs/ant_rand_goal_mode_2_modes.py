...
class AntRandGoalMode2ModesEnv(MetaEnv, gym.utils.EzPickle, MujocoEnv):
    def __init__(self):
    ...
    def sample_tasks(self, n_tasks):
        goal_idx = np.random.randint(0, len(self.mode_locations), n_tasks)
