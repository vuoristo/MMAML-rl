...
class MetaPointEnvMomentumSingleMode(MetaEnv):
    """
    ...
    def __init__(self, reward_type='dense', sparse_reward_radius=2):
        ...
        self.corners = np.array([[5, 5]], dtype=np.float32)
    ...
    def sample_tasks(self, n_tasks):
        goals = self.corners[0] * np.ones((n_tasks, 2))
...
if __name__ == "__main__":
    env = MetaPointEnvMomentumSingleMode()
    while True:
